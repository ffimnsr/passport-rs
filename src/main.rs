...
async fn main() -> io::Result<()> {
    ...
    let app = move || {
        ...
        App::new()
            ...
            .service(web::resource("/countries").route(web::get().to(api::get_all_jobs)))
            .service(web::resource("/countries/{id}").route(web::get().to(api::get_job)))
            .service(web::resource("/orgs").route(web::get().to(api::get_all_jobs)))
            .service(web::resource("/orgs/{id}").route(web::get().to(api::get_job)))
            .service(web::resource("/work/functions").route(web::get().to(api::get_all_jobs)))
            .service(web::resource("/work/functions/{id}").route(web::get().to(api::get_job)))
            .service(web::resource("/work/industries").route(web::get().to(api::get_all_jobs)))
            .service(web::resource("/work/industries/{id}").route(web::get().to(api::get_job)))
            .service(web::resource("/users").route(web::get().to(api::get_all_jobs)))
            .service(web::resource("/users/{id}").route(web::get().to(api::get_job)))
